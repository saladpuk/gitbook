...
Developer หลายๆคนจะบ่นว่า _"การเขียนเทสทำให้งานช้า"_ เลยหลีกเลี่ยงไม่ยอมเขียนเทสก่อนเขียนโค้ด แต่ในขณะที่ครูระดับระดับตำนานและนักเขียนโค้ดระดับเทพทุกคนเขาเขียนเทสกันก่อนเขียนโค้ดทุกคน และงานเขียนใหญ่ก็ชี้ออกมาแล้วว่า **"การเขียนเทสก่อนสุดท้ายมันเร็วกว่าการไม่เขียนเทสเยอะมาก"**
{% endhint %}

![Agile Principles, Patterns, and Practices in C\# \(Robert C. Martin\)](../.gitbook/assets/image%20%285%29.png)
