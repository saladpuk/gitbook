...
ในการทำ Inheritance มันจะมีลำดับชั้นความสัมพันธ์กันว่าใครเป็น **คลาสแม่ คลาสลูก** กันเสมอ ซึ่งจากโค้ดตัวอย่างด้านทั้งหมดก็สามารถเอามาเขียนเป็นแผนภาพ UML ง่ายๆได้ประมาณนี้
...
{% hint style="warning" %}
**หมายเหตุ**  
ใน C\# เราสามารถทำการสืบทอดได้ทีละ 1 คลาสเท่านั้น หรือพูดง่ายๆคือ **มีแม่ได้เพียงคนเดียว** นะจ๊ะ
{% endhint %}
