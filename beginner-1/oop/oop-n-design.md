...
ความสัมพันธ์ในลักษณะ **ถือครอง** เช่น

* นักดาป **มี** Bash และ Magnum Break
* พระ **มี** Divine Protection

ดังนั้นในการออกแบบของที่เป็น HAS A เราจะใช้ **Composition** หรือไม่ก็ **Aggregation** นั่นเอง \(ไม่รู้เรื่องช่างมันอ่านต่อไปก่อน\) ดังนั้นสิ่งแรกที่เราต้องทำคือใช้ Abstraction แปลงเจ้า ความสามารถ หรือ Skill ให้กลายมาเป็น Model เสียก่อน ซึ่งผมก็จะได้ออกมาเป็นแบบนี้
...
จากรูปนี้เลยทำให้ตัวละครเรามีได้หลาย skill ขึ้นอยู่กับว่าเราจะยอมให้มันมี skill อะไรบ้างนั่นเอง

![](../../.gitbook/assets/image%20%28512%29.png)

ซึ่งทั้งหมดนั่นเราก็สามารถเขียนเป็นโค้ดด้านว่า
...
> **หมายเหตุ**  
> IEnumerable ในภาษา C\# คือ Collection นั่นเอง
...
โอ้วววว เรียบร้อยงอดแงมตามท้องเรื่อง \(จะได้ไปนอนซะที ฮ่าๆ\)
