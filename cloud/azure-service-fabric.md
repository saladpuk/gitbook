...
{% hint style="danger" %}
ขออภัยมือลั่นไปกด publish เดี๋ยวเอา วีดีโอมาใส่ตอนเย็นๆ
{% endhint %}
...
![https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-overview](../.gitbook/assets/image%20%28387%29.png)
...
* ติดตั้ง Service Fabric บนเครื่องตัวเอง
* ลองเขียน Service Fabric ตัวแรกของเรากัน
