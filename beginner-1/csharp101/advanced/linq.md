...
ซึ่งจากประสบการณ์ที่สอนมาผมพบว่า เราไปดูตัวอย่างกันแล้วจะเข้าใจ LINQ ได้เร็วกว่าอ่านทฤษฎีครับ ดังนั้นผมจะใช้ตัวอย่างนี้อธิบายเอานะ โดยโจทย์ของผมคือถ้าผมมีข้อมูลตัวเลข 1~7 อยู่ใน array ตามโค้ดด้านล่าง

```csharp
var numbers = new int[] { 1, 2, 3, 4, 5, 6, 7 };
```

แล้วถ้าเกิดผมอยาก**ดึงเฉพาะเลขคู่**ออกมาจากตัวแปร `number` ล่ะต้องทำยังไง ? ซึ่งถ้าเขียนโค้ดแบบปรกติเราก็จะเขียนออกมาได้ราวๆนี้
...
ตาไม่ได้ฝาดไปหรอกครับ มันเขียนแทบจะเหมือนภาษา **SQL syntax** เลยยังไงล่ะ ดังนั้นใครที่เขียน sql syntax เป็นอยู่แล้วรับรองครับว่าสบายเลย
...
คราวนี้เจ้าตัวอย่างโค้ดด้านบน เราสามารถเขียนแบบย่อๆให้กระชับลงได้อีกนะ ตามโค้ดด้านล่างเลย

```csharp
var evenNumbers = numbers.Where(it => it % 2 == 0);
```

ไม่ว่าจะเป็นแบบเต็มหรือแบบย่อการทำงานมันเหมือนกันครับ ขึ้นอยู่กับว่าถนัดแบบไหน ซึ่งปรกติ**ผมแนะนำว่าให้เขียนแบบย่อครับ**
...
อยากเขียน LINQ เป็นจริงๆนั้นง่ายมาก เพราะ LINQ มีหัวใจการทำงานแค่ 3 เรื่องเท่านั้น  โดยผมจะใช้โจทย์โชว์เลขคู่ในตอนแรก มาเขียนกำกับหัวใจการทำงานไว้เป็นแบบนี้
...
| คำสั่ง | ใช้สำหรับ | ผลลัพท์ |
| :--- | :--- | :--- |
| ToArray | แปลงเป็น array | Array |
| ToList | แปลงเป็น list | List |
...
แล้วผมต้องการข้อมูล4 กลุ่มตามนี้
