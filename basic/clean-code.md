...
![&#xE20;&#xE32;&#xE1E;&#xE08;&#xE32;&#xE01; ronjeffries.com](../.gitbook/assets/image%20%2814%29.png)
...
![&#xE20;&#xE32;&#xE1E;&#xE08;&#xE32;&#xE01; ronjeffries.com](../.gitbook/assets/image%20%2811%29.png)
...
> ลองทำโค้ดด้านล่างแล้วทำความเข้าใจดูครับว่ามันจะสื่อว่าอะไร ?   
...
* **อย่าเขียนคอมเมนต์!!** ถ้าเขียนคอมเมนต์แสดงว่าโค้ดคุณไม่ได้เข้าใจง่ายพอเลยต้องเขียนคอมเมนต์ ให้ทำสร้าง method ที่ทำให้อ่านแล้วเข้าใจได้ง่ายแทน
...
private updateAddress(UserProfile user, Address address) ...

// updateAddress() เราก็ไปสร้างเป็น private ไว้เรียกใช้อีกที
// เพราะใจความของ UpsertAddress() มันมีจบในบรรทัดที่ 3~4 แล้ว
```

### 🔥 การตั้งชื่อทั่วไป

* เวลาจะตั้งชื่ออะไรก็แล้ว **ต้องตั้งให้มันสื่อความหมาย** อ่านแล้วเข้าใจว่ามันมีไว้เพื่ออะไร
* ชื่อต้อง **อ่านออกเสียงได้** ถ้ามันออกเสียงไม่ได้เวลาจะบอกคนอื่นว่ามันผิดที่ไหน คุณจะบอกเขายังไง?
* **หลีกเลี่ยงคำย่อ** เพราะทุกคนย่อคำไม่เหมือนกัน Student คุณจะย่อว่าอะไร \(std? โรคติดต่อทางเพศ\)
* ชื่อควร**ตั้งชื่อถูกพฤติกรรม** เช่น ชื่อ**คลาสควรเป็นคำนาม**, ชื่อ **method ควรขึ้นด้วยคำกิริยา**
...
* ควรตั้งชื่อเป็นคำกิริยา เพราะคนเรียกใช้อ่านแล้วรู้เลยว่าใช้ทำอะไร \(คนไทยอาจะไม่มีผลเท่าไหร่แต่ฝรั่งนี่มีสูงเลย\)
...
เรื่อง Clean Code มันเป็นเรื่องความเอาใจใส่ในผลงานของตัวเอง ซึ่งผลลัพท์ที่ได้มันจะทำให้เราไม่เสียเวลาหลงทางในเขาวงกต และมันไม่ได้มีแค่เท่านี้หรอก อันนี้เป็นเพียงน้ำจิ้มส่วนนึงเท่านั้น และแต่ละภาษาก็มีหลักในการทำ clean code ในรูปแบบของเขาอยู่เช่นกัน เลยขอดึงเฉพาะตัวที่เป็นกลางๆมาให้ดูก่อน
