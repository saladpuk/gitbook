...
{% hint style="warning" %}
ในตอนนี้กำลังไล่ปิดบทความของ [👶 Microservices พื้นฐาน](https://saladpuk.gitbook.io/learn/basic/microservices) อยู่ครับรบกวนไปวิ่งเล่นซัก 2,000 รอบแล้วค่อยกลับมาอ่านต่อนะ เพราะช่วงนี้น่าจะวุ่นวายๆเลยทำให้บทความนี้น่าจะออกมาราวๆวันที่ **14**/10/2019 นี้ครับ
{% endhint %}
