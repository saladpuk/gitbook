...
> **Inheritance** คือการ**สืบทอดคุณสมบัติ** ซึ่งจะช่วยให้เร**าต่อยอดความสามารถใหม่ๆเข้าไปใน Model ได้** โดยไม่ต้องแก้ของเดิม
...
เพียงเท่านี้ _บัญชีออมทรัพย์_ และ _บัญชีกระแสรายวัน_ ก็จะมีความสามารถทุกอย่างที่ตัวต้นแบบมีนั่นเอง ดังนั้นลองเขียนโค้ดลองเล่นกับบัญชีทั้ง 2 ตัวของเราดู
...
{% hint style="success" %}
✨ ของที่อยู่ใน Base class จะถูกส่งลงมาให้ Sub class ทุกอย่างเลย ส่วน sub class จะใช้มันได้หรือเปล่าขึ้นอยู่กับ accessibility ของ property พวกนั้น
{% endhint %}
...
เพราะทุกอย่างที่ตัวคลาสแม่มี คลาสลูกจะมีด้วยหมดเลยทุกตัว **แต่จะใช้งานได้หรือเปล่าขึ้นอยู่กับ accessibility ที่ตัวแม่ตั้งไว้** เช่นตัวแปร balance มันเป็น private คลาสลูกจะไม่สามารถอ้างถึงได้นั่นเอง
...
เพียงเท่านี้เราก็จะสามารถถอนเงินได้ละ ส่วน บัญชีกระแสรายวัน เราก็ไปเขียนเพิ่มให้มันสามารถถอนเงินได้เกินเงินที่มี  อยู่ในชัญชี ซึ่งสมมุติว่าวงเงินกู้ได้ไม่เกิน 1,000 ละกัน ดังนั้นเราก็จะได้โค้ดออกมาตามนี้
...
{% hint style="danger" %}
**ข้อควรระวัง**  
อย่างใช้ Inheritance เพราะเราขี้เกียจเขียนโค้ดซ้ำๆ เพราะมันจะได้ความสัมพันธ์แบบ Is A เข้าไปด้วย \(เดี๋ยวไปดูความร้ายแรงของมันในบทของ Polymorphism เอาละกัน\)
{% endhint %}
